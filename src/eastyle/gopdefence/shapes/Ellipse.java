...
public class Ellipse extends Shape {
  ...
  public Ellipse(float pX, float pY, float radius, float lineWidth, boolean filled) {
  ...
  public boolean contains(float pX, float pY) {  
          return RectangularShapeCollisionChecker.checkContains(collisionRectangle, pX, pY); //TODO Ellipse Collision
  }
